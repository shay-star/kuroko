...
/**
 * @brief Index numbers for always-available interned strings representing important
 ...
 * interned @c KrkString, we keep an array of the @c KrkString pointers in the global VM
 * state.
 *
...
#define krk_hash_advance(hash, c)                                                        \
    do {                                                                                 \
