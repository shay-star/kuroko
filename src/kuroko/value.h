...
#    define BOOLEAN_VAL(value)                                                           \
        ((KrkValue)(((uint64_t)(value) & KRK_VAL_MASK_LOW) | KRK_VAL_MASK_BOOLEAN))
#    define INTEGER_VAL(value)                                                           \
        ((KrkValue)(((uint64_t)(value) & KRK_VAL_MASK_LOW) | KRK_VAL_MASK_INTEGER))
#    define KWARGS_VAL(value) ((KrkValue)((uint32_t)(value) | KRK_VAL_MASK_KWARGS))
#    define OBJECT_VAL(value)                                                            \
        ((KrkValue)((_krk_sanitize((uintptr_t)(value)) & KRK_VAL_MASK_LOW) |             \
                    KRK_VAL_MASK_OBJECT))
#    define HANDLER_VAL(ty, ta)                                                          \
        ((KrkValue)((uint64_t)((((uint64_t)ty) << 32) | ((uint32_t)ta)) |                \
                    KRK_VAL_MASK_HANDLER))
...
#    define AS_INTEGER(value)                                                            \
        ((krk_integer_type)(KRK_SX(value) ? (KRK_IX(value) | KRK_VAL_MASK_NONE)          \
                                          : (KRK_IX(value))))
...
#    define AS_OBJECT(value)                                                             \
        ((KrkObj *)(uintptr_t)(((value) & KRK_VAL_MASK_LOW) | KRK_HEAP_TAG))
...
#    define IS_INTEGER(value)                                                            \
        ((((value) >> 48L) & (KRK_VAL_MASK_HANDLER >> 48L)) ==                           \
         (KRK_VAL_MASK_BOOLEAN >> 48L))
...
#    define INTEGER_VAL(value)                                                           \
        ((KrkValue){KRK_VAL_INTEGER, ((uint64_t)(value)) & 0xFFFFffffFFFFULL})
...
#    define HANDLER_VAL(ty, ta)                                                          \
        ((KrkValue){KRK_VAL_HANDLER,                                                     \
                    ((uint64_t)((((uint64_t)ty) << 32) | ((uint32_t)ta)))})
#    define FLOATING_VAL(value)                                                          \
        ((KrkValue){KRK_VAL_FLOATING, (((KrkValueDbl){.dbl = (value)}).val)})
